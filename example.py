...
if __name__ == "__main__":
    ...
    r0 = 1
    kappa = np.complex(4571.4285714285725 + 457.14285714285717j)
    ...
    ax[0].set_xlabel("Dimensionless frequency")
    ax[1].grid()
    ax[1].set_ylim(0, 2)
    ax[1].set_xlim(0, 6.2)
    ax[1].set_ylabel("Damping coefficient")
    ax[1].set_xlabel("Dimensionless frequency")
    ax[2].grid()
    ax[2].set_ylim(0, 5)
    ax[2].set_xlim(0, 6.2)
    ax[2].set_ylabel("Magnitude")
    ax[2].set_xlabel("Dimensionless frequency")
    plt.tight_layout()
    plt.show()
